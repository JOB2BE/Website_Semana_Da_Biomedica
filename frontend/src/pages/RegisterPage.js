				...
				>
					{!validated ? (
						<Box className={'NotValidated'}>
							...
							<FormControl className={'PasswordContainer'} isRequired>
								<FormControl.Label>
							...
							<FormControl className={'ConfirmPasswordContainer'} isRequired>
								<FormControl.Label>
							...
							<FormControl
								className={'DegreeContainer'}
								isInvalid={'degree' in errors}
							>
								<FormControl.Label>
